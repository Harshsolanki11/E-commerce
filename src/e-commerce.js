 ...
 import kurti from './image/kurti.png'
 import short from './image/short.png'
 import long from './image/long.png'
 import cort from './image/cort.png'
 ...
 import pavv from './image/pavv.png'
 import cake from './image/cake.png'
 import biskit from './image/biskit.png'
 import breds from './image/breds.png'
 import bred from './image/bred.png'
const Ecommerce = () => {
    return (
        <>
            {/* nav bar start */}
            ...
            <div className='elp'>
            <div>
            <img src={macbook} width={115} height={125}></img> <br></br>
            <span className='mac1' >
                Macbook Pro 2014 <br></br>
                <b className='mac1' >235,000 ugx</b><br></br>
                <a href='/cart' className='addtocart1'>Add to Cart</a><br></br>
            </span>
            </div>    
            <div>
            <img src={smartwatch} width={115} height={125}></img>
            <span className='smartwatch1' >
            <br></br>Watch 
            <br></br><b className='smartwatch1' >135,000 ugx</b>
            <br></br><a className='addtocart1'>Add to Cart</a>
            </span>
            </div>
            <div>
            <img src={phone} width={80} height={125}></img>
            <span className='phone1' >
            <br></br>Samsung Galaxy 
            <br></br><b className='phone1' >335,000 ugx</b>
            <br></br><a className='addtocart1'>Add to Cart</a>
            </span>
            </div>
            <div>
            <img src={kettle} width={115} height={125}></img>
            <span className='kettli1' >
            <br></br>Electric Kettle 
            <br></br><b className='kettli1' >5,000 ugx</b>
            <br></br><a className='addtocart1'>Add to Cart</a>
            </span>
            </div>
            <div>
            <img src={headphone} width={115} height={125}></img>
            <span className='headphone1' >
            <br></br>Headphones 
            <br></br><b className='headphone1' >15,000 ugx</b>
            <br></br><a className='addtocart1'>Add to Cart</a>
            </span>
            </div>
            ...
            <div className='elp'>
            <div>
            <img src={kurti} width={115} height={125}></img>
            <span className='kurti1' >
            <br></br>Red Floral Dress
            <br></br><b className='kurti' >35,000 ugx</b>
            <br></br><a className='addtocart1'>Add to Cart</a>
            </span>
            </div>
            <div>
            <img src={short} width={115} height={125}></img>
            <span className='short1' >
            <br></br>Jean Shosrts
            <br></br><b className='short' >65,000 ugx</b>
            <br></br><a className='addtocart1'>Add to Cart</a>
            </span>
            </div>
            <div>
            <img src={long} width={115} height={125}></img>
            <span className='long1' >
            <br></br>Pink Trousers Women
            <br></br><b className='long' >35,000 ugx</b>
            <br></br><a className='addtocart1'>Add to Cart</a>
            </span>
            </div>
            <div>
            <img src={cort} width={115} height={125}></img>
            <span className='cort1' >
            <br></br>Suit
            <br></br><b className='cort' >225,000 ugx</b>
            <br></br><a className='addtocart1'>Add to Cart</a>
            </span>
            </div>
            <div>
            <img src={tshirt} width={115} height={125}></img>
            <span className='tshirt1' >
            <br></br>T-Shirt
            <br></br><b className='tshirt' >55,000 ugx</b>
            <br></br><a className='addtocart1'>Add to Cart</a>
            </span>
            </div>
            ...
            <div className='elp'>
            <div>
            <img src={formal} width={115} height={125}></img>
            <span className='formal1' >
            <br></br>Leather Shoes
            <br></br><b className='formal' >95,150 ugx</b>
            <br></br><a className='addtocart1'>Add to Cart</a>
            </span>
            </div>
            <div>
            <img src={hill} width={115} height={125}></img>
            <span className='hill1' >
            <br></br>Women's shoes
            <br></br><b className='hill' >95,000 ugx</b>
            <br></br><a className='addtocart1'>Add to Cart</a>
            </span>
            </div>
            <div>
            <img src={classic} width={115} height={125}></img>
            <span className='classic1' >
            <br></br>Sneakers
            <br></br><b className='classic' >125,000 ugx</b>
            <br></br><a className='addtocart1'>Add to Cart</a>
            </span>
            </div>
            <div>
            <img src={sport} width={115} height={125}></img>
            <span className='sport1' >
            <br></br>Nick shoes
            <br></br><b className='sport' >35,050 ugx</b>
            <br></br><a className='addtocart1'>Add to Cart</a>
            </span>
            </div>
            <div>
            <img src={sport1} width={115} height={125}></img>
            <span className='sport11' >
            <br></br>Shoes
            <br></br><b className='sport1' >35,000 ugx</b>
            <br></br><a className='addtocart1'>Add to Cart</a>
            </span>
            </div>
            ...
            <div className='elp'>
            <div>
            <img src={pavv} width={115} height={125}></img>
            <span className='pavv1' >
            <br></br>Bread
            <br></br><b className='pavv' >5,000 ugx</b>
            <br></br><a className='addtocart1'>Add to Cart</a>
            </span>
            </div>
            <div>
            <img src={cake} width={115} height={125}></img>
            <span className='cake1' >
            <br></br>Cakes
            <br></br><b className='cake' >65,000 ugx</b>
            <br></br><a className='addtocart1'>Add to Cart</a>
            </span>
            </div>
            <div>
            <img src={biskit} width={115} height={125}></img>
            <span className='biskit1' >
            <br></br>Cookies
            <br></br><b className='biskit' >1,200 ugx</b>
            <br></br><a className='addtocart1'>Add to Cart</a>
            </span>
            </div>
            <div>
            <img src={breds} width={115} height={125}></img>
            <span className='breds' >
            <br></br>Hot Loaf
            <br></br><b className='cort' >35,000 ugx</b>
            <br></br><a className='addtocart1'>Add to Cart</a>
            </span>
            </div>
            <div>
            <img src={bred} width={115} height={125}></img>
            <span className='bred1' >
            <br></br>Supa Loaf
            <br></br><b className='bred' >55,000 ugx</b>
            <br></br><a className='addtocart1'>Add to Cart</a>
            </span>
            </div>
